    ...
    , m_minimumGroupBoxWidth(set->getMinimumGroupBoxWidth())
{
    ...
    // Inner widget holds all groups — scroll area wraps it
...
void Options3DWidget::createRenderingGroup() {
    ...
    // Height scale
    m_heightScaleLabel = new QLabel("Height Scale: 1.0", this);
    ...
    m_heightScaleSlider->setValue(1);
    ...
    m_waterfallOffsetLabel = new QLabel("Waterfall Offset: 17.0", this);
    ...
    m_waterfallOffsetSlider->setValue(17);  // 17 dB default
