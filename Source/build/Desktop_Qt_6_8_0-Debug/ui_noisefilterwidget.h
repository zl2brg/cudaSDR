...
public:
    ...
    void setupUi(QWidget *NoiseFilterWidget)
    {
        if (NoiseFilterWidget->objectName().isEmpty())
            NoiseFilterWidget->setObjectName("NoiseFilterWidget");
        ...
        nrModeComboBox->addItem(QString());
        nrModeComboBox->addItem(QString());
        nrModeComboBox->setObjectName("nrModeComboBox");
        ...
        nbModeComboBox->addItem(QString());
        nbModeComboBox->addItem(QString());
        nbModeComboBox->setObjectName("nbModeComboBox");
        ...
        nr2GainComboBox->addItem(QString());
        nr2GainComboBox->addItem(QString());
        nr2GainComboBox->setObjectName("nr2GainComboBox");
        ...
        anfCheckBox->setObjectName("anfCheckBox");
        ...
        snbCheckBox->setObjectName("snbCheckBox");
        ...
        nr2aeCheckBox->setObjectName("nr2aeCheckBox");
        ...
        preAGCCheckBox->setObjectName("preAGCCheckBox");
        ...
        postAGCCheckBox->setObjectName("postAGCCheckBox");
        ...
        mmseCheckBox->setObjectName("mmseCheckBox");
        ...
        omsCheckBox->setObjectName("omsCheckBox");
