...
namespace {
struct qt_meta_tag_ZN16DisplayTabWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto DisplayTabWidget::qt_create_metaobjectdata<qt_meta_tag_ZN16DisplayTabWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'show3DPanadapter'
        QtMocHelpers::SlotData<void(bool)>(10, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 11 },
        }}),
        // Slot 'create3DDockWidget'
        QtMocHelpers::SlotData<void(QWidget *)>(12, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 13, 14 },
        }}),
        // Slot 'systemStateChanged'
        QtMocHelpers::SlotData<void(QObject *, QSDR::_Error, QSDR::_HWInterfaceMode, QSDR::_ServerMode, QSDR::_DataEngineState)>(15, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QObjectStar, 3 }, { 0x80000000 | 16, 17 }, { 0x80000000 | 18, 19 }, { 0x80000000 | 20, 21 },
            { 0x80000000 | 22, 23 },
        }}),
    ...
    return QtMocHelpers::metaObjectData<DisplayTabWidget, qt_meta_tag_ZN16DisplayTabWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject DisplayTabWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QTabWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16DisplayTabWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16DisplayTabWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN16DisplayTabWidgetE_t>.metaTypes,
    nullptr
} };

void DisplayTabWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<DisplayTabWidget *>(_o);
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->show3DPanadapter((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 7: _t->create3DDockWidget((*reinterpret_cast< std::add_pointer_t<QWidget*>>(_a[1]))); break;
        ...
        case 9: _t->setAlexPresence((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 10: _t->setPennyPresence((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DisplayTabWidget::*)(QObject * )>(_a, &DisplayTabWidget::showEvent, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (DisplayTabWidget::*)(QObject * )>(_a, &DisplayTabWidget::closeEvent, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (DisplayTabWidget::*)(QString )>(_a, &DisplayTabWidget::messageEvent, 2))
            return;
    }
}
...
void *DisplayTabWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16DisplayTabWidgetE_t>.strings))
