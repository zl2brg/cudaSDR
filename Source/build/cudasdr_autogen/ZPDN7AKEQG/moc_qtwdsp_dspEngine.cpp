...
#include "../../../src/QtWDSP/qtwdsp_dspEngine.h"
...
template <> constexpr inline auto QWDSPEngine::qt_create_metaobjectdata<qt_meta_tag_ZN11QWDSPEngineE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'getQtDSPStatus'
        QtMocHelpers::SlotData<bool() const>(1, 2, QMC::AccessPublic, QMetaType::Bool),
        ...
        // Slot 'getReceiver'
        QtMocHelpers::SlotData<int() const>(52, 2, QMC::AccessPublic, QMetaType::Int),
        // Slot 'getSampleRate'
        QtMocHelpers::SlotData<int() const>(53, 2, QMC::AccessPublic, QMetaType::Int),
        // Slot 'getFFTSize'
        QtMocHelpers::SlotData<int() const>(54, 2, QMC::AccessPublic, QMetaType::Int),
        // Slot 'getDSPMode'
        QtMocHelpers::SlotData<DSPMode() const>(55, 2, QMC::AccessPublic, 0x80000000 | 13),
        // Slot 'getSize'
        QtMocHelpers::SlotData<int() const>(56, 2, QMC::AccessPublic, QMetaType::Int),
    };
...
void QWDSPEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 34: { int _r = _t->getReceiver();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 35: { int _r = _t->getSampleRate();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 36: { int _r = _t->getFFTSize();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 37: { DSPMode _r = _t->getDSPMode();
            if (_a[0]) *reinterpret_cast< DSPMode*>(_a[0]) = std::move(_r); }  break;
        case 38: { int _r = _t->getSize();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
