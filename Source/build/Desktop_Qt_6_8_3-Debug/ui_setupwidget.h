...
public:
    ...
    void setupUi(QDialog *SetupWidget)
    {
        ...
        hw_none_btn->setObjectName("hw_none_btn");

        horizontalLayout_3->addWidget(hw_none_btn);

        hw_network_btn = new AeroButton(groupBox_3);
        hw_network_btn->setObjectName("hw_network_btn");
        ...
        ipaddr_combo->setObjectName("ipaddr_combo");
        ...
        skt_buffer_enable_btn->setObjectName("skt_buffer_enable_btn");

        horizontalLayout_6->addWidget(skt_buffer_enable_btn);

        skt_buffer_size_combo = new QComboBox(groupBox_4);
        skt_buffer_size_combo->setObjectName("skt_buffer_size_combo");
        ...
        hpsdr_search_btn->setObjectName("hpsdr_search_btn");

        horizontalLayout_7->addWidget(hpsdr_search_btn);

        hpsdr_ip_combo = new QComboBox(groupBox_4);
        hpsdr_ip_combo->setObjectName("hpsdr_ip_combo");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, SetupWidget, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, SetupWidget, qOverload<>(&QDialog::reject));
