 ...
 //   qDebug() << "sendstate" <<  m_sendState;
    switch (m_sendState) {
    	...
    	case 0:
    		...
    		// Bits 1,0
      //      de->setSampleRate(this, set->getSampleRate());
      ...
      //      de->setHPSDRConfig();
            ...
            de->io.control_out[2] = de->io.control_out[2] & 0xFE; // 1 1 1 1 1 1 1 0
            de->io.control_out[2] = de->io.control_out[2] | de->io.rxClass;
