 ...
 *
 *	 using original C code by John Melton, G0ORX/N6LYT and Dave McMcQuate,
 *WA8YWQ
 *
...
private slots:
    void systemStateChanged(QObject *sender, QSDR::_Error err,
                            QSDR::_HWInterfaceMode hwmode, QSDR::_ServerMode mode,
...
private slots:
    ...
    static void
    displayDataProcessorSocketError(QAbstractSocket::SocketError error);
...
private:
    ...
    // RRK	long			m_sendSequence;//RRK	long
    // m_oldSendSequence;
...
public:
    AudioOutProcessor(DataEngine *de = nullptr,
                      QSDR::_ServerMode serverMode = QSDR::NoServerMode);
