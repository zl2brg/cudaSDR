...
#include "../../../Source/src/cusdr_extCtrlWidget.h"
...
namespace {
struct qt_meta_tag_ZN13ExtCtrlWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto ExtCtrlWidget::qt_create_metaobjectdata<qt_meta_tag_ZN13ExtCtrlWidgetE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "messageEvent",
        "enable",
        "receivePinsBtnClicked",
        "transmitPinsBtnClicked"
    };
    ...
    return QtMocHelpers::metaObjectData<ExtCtrlWidget, qt_meta_tag_ZN13ExtCtrlWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject ExtCtrlWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13ExtCtrlWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13ExtCtrlWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13ExtCtrlWidgetE_t>.metaTypes,
    nullptr
} };

void ExtCtrlWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<ExtCtrlWidget *>(_o);
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ExtCtrlWidget::*)(QObject * )>(_a, &ExtCtrlWidget::showEvent, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ExtCtrlWidget::*)(QObject * )>(_a, &ExtCtrlWidget::closeEvent, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (ExtCtrlWidget::*)(QString )>(_a, &ExtCtrlWidget::messageEvent, 2))
            return;
    }
}
...
void *ExtCtrlWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13ExtCtrlWidgetE_t>.strings))
