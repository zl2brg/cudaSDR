...
template <> constexpr inline auto Settings::qt_create_metaobjectdata<qt_meta_tag_ZN8SettingsE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(int, const qVectorFloat &)>(276, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 19 }, { 0x80000000 | 34, 35 },
        }}),
        // Slot 'setPostSpectrumBuffer'
        QtMocHelpers::SlotData<void(int, const float *)>(277, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 19 }, { 0x80000000 | 37, 2 },
        }}),
        // Slot 'setSampleSize'
        QtMocHelpers::SlotData<void(QObject *, int, int)>(278, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { QMetaType::Int, 39 },
        }}),
        // Slot 'setRxList'
        QtMocHelpers::SlotData<void(QList<Receiver*>)>(279, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 41, 42 },
        }}),
        // Slot 'setMetisCardList'
        QtMocHelpers::SlotData<void(QList<TNetworkDevicecard>)>(280, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 68, 69 },
        }}),
        // Slot 'searchHpsdrNetworkDevices'
        QtMocHelpers::SlotData<void()>(281, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'clearMetisCardList'
        QtMocHelpers::SlotData<void()>(282, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'setHPSDRDeviceNumber'
        QtMocHelpers::SlotData<void(int)>(283, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 29 },
        }}),
        // Slot 'setCurrentHPSDRDevice'
        QtMocHelpers::SlotData<void(TNetworkDevicecard)>(284, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 74, 75 },
        }}),
        // Slot 'addNetworkIOComboBoxEntry'
        QtMocHelpers::SlotData<void(QString)>(285, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 78 },
        }}),
        ...
        QtMocHelpers::SlotData<void(QString, QString)>(287, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 60 }, { QMetaType::QString, 61 },
        }}),
        ...
        QtMocHelpers::SlotData<void(int)>(292, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 291 },
        }}),
        ...
        // Slot 'setServerAddr'
        QtMocHelpers::SlotData<void(QObject *, QString)>(295, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::QString, 82 },
        }}),
        ...
        // Slot 'setServerPort'
        QtMocHelpers::SlotData<void(QObject *, quint16)>(297, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::UShort, 85 },
        }}),
        // Slot 'setListenPort'
        ...
        QtMocHelpers::SlotData<void(QObject *, bool)>(301, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Bool, 29 },
        }}),
        // Slot 'setClientNoConnected'
        QtMocHelpers::SlotData<void(QObject *, int)>(302, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 46 },
        }}),
        // Slot 'setRxConnectedStatus'
        QtMocHelpers::SlotData<void(QObject *, int, bool)>(303, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { QMetaType::Bool, 29 },
        }}),
        // Slot 'setAudioRx'
        QtMocHelpers::SlotData<void(QObject *, int)>(304, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 },
        }}),
        // Slot 'setConnected'
        ...
        QtMocHelpers::SlotData<void(QObject *, THPSDRDevices)>(307, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { 0x80000000 | 71, 72 },
        }}),
        // Slot 'setHermesVersion'
        QtMocHelpers::SlotData<void(int)>(308, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 29 },
        }}),
        ...
        QtMocHelpers::SlotData<void(bool)>(310, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 29 },
        }}),
        // Slot 'setMercuryVersion'
        QtMocHelpers::SlotData<void(int)>(311, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 29 },
        }}),
        // Slot 'setPenelopePresence'
        QtMocHelpers::SlotData<void(bool)>(312, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 29 },
        }}),
        ...
        QtMocHelpers::SlotData<void(QObject *, quint16)>(319, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::UShort, 320 },
        }}),
        // Slot 'setAlexHPFLoFrequencies'
        QtMocHelpers::SlotData<void(int, long)>(321, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 322 }, { QMetaType::Long, 29 },
        }}),
        // Slot 'setAlexHPFHiFrequencies'
        QtMocHelpers::SlotData<void(int, long)>(323, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 322 }, { QMetaType::Long, 29 },
        }}),
        ...
        // Slot 'setAlexStates'
        QtMocHelpers::SlotData<void(QObject *, const QList<int> &)>(326, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { 0x80000000 | 109, 110 },
        }}),
        // Slot 'setAlexState'
        QtMocHelpers::SlotData<void(QObject *, int, int)>(327, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 328 }, { QMetaType::Int, 29 },
        }}),
        // Slot 'setAlexState'
        QtMocHelpers::SlotData<void(QObject *, int)>(327, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 29 },
        }}),
        // Slot 'setAlexToManual'
        QtMocHelpers::SlotData<void(QObject *, bool)>(329, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Bool, 29 },
        }}),
        // Slot 'checkAlexState'
        QtMocHelpers::SlotData<int(int)>(330, 2, QMC::AccessPublic, QMetaType::Int, {{
            { QMetaType::Int, 9 },
        }}),
        // Slot 'setPennyOCEnabled'
        QtMocHelpers::SlotData<void(QObject *, bool)>(331, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Bool, 29 },
        }}),
        // Slot 'setRxJ6Pin'
        QtMocHelpers::SlotData<void(QObject *, HamBand, int)>(332, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { 0x80000000 | 112, 113 }, { QMetaType::Int, 29 },
        }}),
        // Slot 'setRxJ6Pins'
        QtMocHelpers::SlotData<void(QObject *, const QList<int> &)>(333, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { 0x80000000 | 109, 110 },
        }}),
        // Slot 'setTxJ6Pin'
        QtMocHelpers::SlotData<void(QObject *, HamBand, int)>(334, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { 0x80000000 | 112, 113 }, { QMetaType::Int, 29 },
        }}),
        // Slot 'setTxJ6Pins'
        QtMocHelpers::SlotData<void(QObject *, const QList<int> &)>(335, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { 0x80000000 | 109, 110 },
        }}),
        // Slot 'setIQPort'
        QtMocHelpers::SlotData<void(QObject *, int, int)>(336, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { QMetaType::Int, 85 },
        }}),
        // Slot 'setProtocolSync'
        QtMocHelpers::SlotData<void(int)>(337, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 29 },
        }}),
        // Slot 'setADCOverflow'
        ...
        // Slot 'setReceivers'
        QtMocHelpers::SlotData<void(QObject *, int)>(342, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 29 },
        }}),
        ...
        // Slot 'setMicSource'
        QtMocHelpers::SlotData<void(int)>(350, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 130 },
        }}),
        // Slot 'setMicInputDev'
        ...
        QtMocHelpers::SlotData<void(QObject *, int, int, long)>(356, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 16 }, { QMetaType::Int, 19 }, { QMetaType::Long, 140 },
        }}),
        // Slot 'setCtrFrequency'
        QtMocHelpers::SlotData<void(int, long)>(356, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 19 }, { QMetaType::Long, 140 },
        }}),
        // Slot 'getCtrFrequency'
        QtMocHelpers::SlotData<long(int)>(357, 2, QMC::AccessPublic, QMetaType::Long, {{
            { QMetaType::Int, 19 },
        }}),
        // Slot 'setVFOFrequency'
        QtMocHelpers::SlotData<void(QObject *, int, int, long)>(358, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 16 }, { QMetaType::Int, 19 }, { QMetaType::Long, 140 },
        }}),
        // Slot 'setVfoFrequency'
        QtMocHelpers::SlotData<void(int, long)>(359, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 19 }, { QMetaType::Long, 140 },
        }}),
        // Slot 'getVfoFrequency'
        QtMocHelpers::SlotData<long(int)>(360, 2, QMC::AccessPublic, QMetaType::Long, {{
            { QMetaType::Int, 19 },
        }}),
        // Slot 'setNCOFrequency'
        QtMocHelpers::SlotData<void(QObject *, bool, int, long)>(361, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Bool, 29 }, { QMetaType::Int, 19 }, { QMetaType::Long, 140 },
        }}),
        // Slot 'clientDisconnected'
        QtMocHelpers::SlotData<void(int)>(362, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 46 },
        }}),
        // Slot 'setFramesPerSecond'
        QtMocHelpers::SlotData<void(QObject *, int, int)>(363, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { QMetaType::Int, 29 },
        }}),
        // Slot 'setMouseWheelFreqStep'
        QtMocHelpers::SlotData<void(QObject *, int, qreal)>(364, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { QMetaType::QReal, 29 },
        }}),
        // Slot 'setSocketBufferSize'
        QtMocHelpers::SlotData<void(QObject *, int)>(365, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 29 },
        }}),
        // Slot 'setManualSocketBufferSize'
        QtMocHelpers::SlotData<void(QObject *, bool)>(366, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Bool, 29 },
        }}),
        // Slot 'setReceiverDataReady'
        QtMocHelpers::SlotData<void()>(367, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'setSpectrumSize'
        QtMocHelpers::SlotData<void(QObject *, int)>(368, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 29 },
        }}),
        // Slot 'setdBmPanScaleMin'
        QtMocHelpers::SlotData<void(int, qreal)>(369, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 19 }, { QMetaType::QReal, 29 },
        }}),
        ...
        QtMocHelpers::SlotData<void(qreal)>(371, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QReal, 29 },
        }}),
        ...
        // Slot 'setHamBand'
        QtMocHelpers::SlotData<void(QObject *, int, bool, HamBand)>(373, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { QMetaType::Bool, 161 }, { 0x80000000 | 112, 113 },
        }}),
        // Slot 'setDSPMode'
        QtMocHelpers::SlotData<void(QObject *, int, DSPMode)>(374, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { 0x80000000 | 163, 16 },
        }}),
        // Slot 'setADCMode'
        QtMocHelpers::SlotData<void(QObject *, int, ADCMode)>(375, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { 0x80000000 | 165, 16 },
        }}),
        // Slot 'setAGCMode'
        QtMocHelpers::SlotData<void(QObject *, int, AGCMode)>(376, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { 0x80000000 | 167, 16 },
        }}),
        // Slot 'setAGCGain'
        QtMocHelpers::SlotData<void(QObject *, int, int)>(377, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { QMetaType::Int, 29 },
        }}),
        // Slot 'setAGCMaximumGain_dB'
        QtMocHelpers::SlotData<void(QObject *, int, qreal)>(378, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { QMetaType::QReal, 29 },
        }}),
        ...
        QtMocHelpers::SlotData<void(QObject *, int, int)>(382, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { QMetaType::Int, 29 },
        }}),
        // Slot 'setAGCHangLevel_dB'
        QtMocHelpers::SlotData<void(QObject *, int, qreal)>(383, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { QMetaType::QReal, 29 },
        }}),
        // Slot 'setAGCLineLevels'
        QtMocHelpers::SlotData<void(QObject *, int, qreal, qreal)>(384, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { QMetaType::QReal, 179 }, { QMetaType::QReal, 170 },
        }}),
        // Slot 'setAGCShowLines'
        QtMocHelpers::SlotData<void(QObject *, int, bool)>(385, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { QMetaType::Bool, 29 },
        }}),
        ...
        // Slot 'setfftSize'
        QtMocHelpers::SlotData<void(int, int)>(391, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 19 }, { QMetaType::Int, 39 },
        }}),
        // Slot 'setfmsqLevel'
        ...
        QtMocHelpers::SlotData<void(QObject *, int)>(393, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 29 },
        }}),
        // Slot 'setWidebandSpectrumBuffer'
        QtMocHelpers::SlotData<void(const qVectorFloat &)>(394, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 34, 35 },
        }}),
        // Slot 'resetWidebandSpectrumBuffer'
        QtMocHelpers::SlotData<void()>(395, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'setWidebandOptions'
        QtMocHelpers::SlotData<void(QObject *, TWideband)>(396, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { 0x80000000 | 145, 146 },
        }}),
        // Slot 'setWidebandStatus'
        QtMocHelpers::SlotData<void(QObject *, bool)>(397, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Bool, 29 },
        }}),
        ...
        QtMocHelpers::SlotData<void(QObject *, qreal)>(399, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::QReal, 29 },
        }}),
        ...
        QtMocHelpers::SlotData<void(QObject *, float)>(401, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Float, 328 },
        }}),
        // Slot 'setFreqRulerPosition'
        QtMocHelpers::SlotData<void(QObject *, int, float)>(402, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { QMetaType::Float, 328 },
        }}),
        // Slot 'setAudioFormat'
        QtMocHelpers::SlotData<void(QObject *, const QAudioFormat &)>(403, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { 0x80000000 | 194, 195 },
        }}),
        // Slot 'setAudioPosition'
        QtMocHelpers::SlotData<void(QObject *, qint64)>(404, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::LongLong, 153 },
        }}),
        // Slot 'setAudioBuffer'
        QtMocHelpers::SlotData<void(QObject *, qint64, qint64, const QByteArray &)>(405, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::LongLong, 153 }, { QMetaType::LongLong, 198 }, { QMetaType::QByteArray, 35 },
        }}),
        // Slot 'moveDisplayWidget'
        QtMocHelpers::SlotData<void(int)>(406, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 29 },
        }}),
        // Slot 'setPanadapterColors'
        QtMocHelpers::SlotData<void(TPanadapterColors)>(407, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 408, 409 },
        }}),
        // Slot 'setPanGrid'
        QtMocHelpers::SlotData<void(bool, int)>(410, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 29 }, { QMetaType::Int, 19 },
        }}),
        // Slot 'setPeakHold'
        ...
        QtMocHelpers::SlotData<void(QObject *, int, bool)>(415, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { QMetaType::Bool, 29 },
        }}),
        // Slot 'setSpectrumAveragingCnt'
        QtMocHelpers::SlotData<void(QObject *, int, int)>(416, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QObjectStar, 5 }, { QMetaType::Int, 19 }, { QMetaType::Int, 29 },
        }}),
        // Slot 'setWaterfallTime'
        QtMocHelpers::SlotData<void(int, int)>(417, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 19 }, { QMetaType::Int, 29 },
        }}),
        ...
        QtMocHelpers::SlotData<void(int, PanAveragingMode)>(420, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 19 }, { 0x80000000 | 421, 16 },
        }}),
        // Slot 'setPanDetectorMode'
        QtMocHelpers::SlotData<void(int, PanDetectorMode)>(422, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 19 }, { 0x80000000 | 423, 16 },
        }}),
        // Slot 'setNoiseBlankerMode'
        QtMocHelpers::SlotData<void(int, int)>(424, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 19 }, { QMetaType::Int, 425 },
        }}),
        // Slot 'setNoiseFilterMode'
        QtMocHelpers::SlotData<void(int, int)>(426, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 19 }, { QMetaType::Int, 427 },
        }}),
        // Slot 'setNR2GainMethod'
        QtMocHelpers::SlotData<void(int, int)>(428, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 19 }, { QMetaType::Int, 29 },
        }}),
        ...
        // Slot 'setNR2Ae'
        QtMocHelpers::SlotData<void(int, bool)>(431, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 19 }, { QMetaType::Bool, 29 },
        }}),
        // Slot 'setAnf'
        ...
        QtMocHelpers::SlotData<void(bool)>(434, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 16 },
        }}),
        // Slot 'setRepeaterOffset'
        QtMocHelpers::SlotData<void(int)>(435, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 436 },
        }}),
        // Slot 'setAudioCompression'
        QtMocHelpers::SlotData<void(int)>(437, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 158 },
        }}),
        ...
        QtMocHelpers::SlotData<void()>(452, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'showWarningDialog'
        QtMocHelpers::SlotData<void(const QString &)>(453, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 3 },
        }}),
        // Slot 'showRadioPopupWidget'
        QtMocHelpers::SlotData<void()>(454, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'getCtrFrequencies'
        QtMocHelpers::SlotData<QList<long>()>(455, 2, QMC::AccessPublic, 0x80000000 | 456),
        // Slot 'getVfoFrequencies'
        QtMocHelpers::SlotData<QList<long>()>(457, 2, QMC::AccessPublic, 0x80000000 | 456),
    };
...
void Settings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 195: _t->setSpectrumBuffer((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<qVectorFloat>>(_a[2]))); break;
